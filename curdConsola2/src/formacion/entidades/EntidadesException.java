package formacion.entidades;

public class EntidadesException extends RuntimeException {
	// Add generated serialVersionUID (en el subrayado amarillo de EntidadesException)
	private static final long serialVersionUID = -3159781933534240405L;
